...
*/
  ...
  //   var newBrasil = brasil.map((item, index) => {
  //     return { index: index, estado: item };
  //   });
...
*/
  ...
  var moreThanSeven = brasil.every((item) => {
...
*/
  ...
  var cearaExist = brasil.some((item) => {
    return item === "Ceará";
  });
  console.log(
    cearaExist ? "Ceará está incluído!" : "Ceará não foi incluído :("
  );
