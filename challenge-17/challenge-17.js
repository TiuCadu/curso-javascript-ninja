(() => {
  ...
  */
  ...
  console.log(texto.replace(/(Manuel Marques de Sousa)/, "Carlos Oliveira"));
...
*/
  ...
  console.log(texto.replace(/[D-Hd-h]/g, "0"));
...
*/
  ...
  console.log(
    texto.replace(/O Centauro de Luvas/g, (frase) => {
...
*/
  ...
  console.log(
    `O mês de Março é representado pelo número ${getMonthNumber("marco")}.`
  );
  console.log(
