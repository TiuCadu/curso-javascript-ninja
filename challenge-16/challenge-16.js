 ...
 */
  console.log("\nMeus amigos:");
  var friends = ["Carlos", "Daniela", "Caduzinho", "Julia", "Maria"];
  var phrase = friends
    .reduce((acumulado, atual, index) => {
...
var inicial = "";
var myNewName = myName.split("").reduce((acumulado, atual, index)=>{
    atual = index % 2 === 0 ? atual.toUpperCase() : atual.toLowerCase();
    return acumulado + atual
},inicial)
console.log(myNewName);


  //   var arrayMyName = myName.split("", myName.length);
})();
