...
function convertToHex(color) {
  switch (color.toLowerCase()) {
    case "vermelho":
      ...
      break;
    case "preto":
      console.log(`O hexadecimnal para a cor ${color} é 000000`);
      break;
    case "amarelo":
    ...
    case "azul":
      ...
      break;
    case "roxo":
      console.log(`O hexadecimal para a cor ${color} é 993399`);
      break;
    default:
...
console.log(convertToHex('Ssdasd'));
console.log(convertToHex('asdasdasdasd'));
console.log(convertToHex('asdasdasdasdasdasd'));